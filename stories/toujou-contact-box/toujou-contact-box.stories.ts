...
export const Default: Story = {
  render: () => {
    ...
    wrapper.innerHTML = `
      ...
      <input type="checkbox" name="contact-state" id="contact-state" class="state-input" aria-hidden="true" style="margin-bottom: 2rem; display: none;"/>
      <label for="contact-state" class="button" style="margin-bottom: var(--spacing-normal);">Open contact box</label>
      ...
      <toujou-contact-box class="contact-box">
        <button class="contact-box__close storybook-button" aria-label="Close contact box">Close</button>
